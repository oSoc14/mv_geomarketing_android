...
public class FriendsFragment extends Fragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private static final int LOADER_FRIEND = 2;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getLoaderManager().initLoader(LOADER_FRIEND, null, this);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button b = (Button) v.findViewById(R.id.testButtonFriends);
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle bundle) {
        switch (id)
        {
            case LOADER_FRIEND:
                ...
                final Uri uri = CouponContentProvider.CONTENT_URI_ALL_FRIENDS;
            ...
            case LOADER_FRIEND:
                if(cursor.moveToFirst())
                {
                    ...
                    do
                    {
                        ...
                        String s = cursor.getString(cursor.getColumnIndex(FriendsData.COLUMN_NAME));

                        Log.d("data", "Loaders string " + s);
                    }
