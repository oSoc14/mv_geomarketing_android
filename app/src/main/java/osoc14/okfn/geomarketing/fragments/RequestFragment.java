...
import osoc14.okfn.geomarketing.ListAdapters.MyActivitiesCursorAdaptor;
import osoc14.okfn.geomarketing.ListAdapters.MyRequestsCursorAdaptor;
...
public class RequestFragment extends Fragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private static final int LOADER_ACTIVITIES = 3;
    private static final int LOADER_REQUESTS = 4;
    private ListView listActivities;
    private ListView listRequests;

    private OnFragmentInteractionListener mListener;
    private MyActivitiesCursorAdaptor myActivityAdaptor;
    private MyRequestsCursorAdaptor myRequestAdaptor;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getLoaderManager().initLoader(LOADER_ACTIVITIES, null, this);
        getLoaderManager().initLoader(LOADER_REQUESTS, null, this);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listActivities.setAdapter(myActivityAdaptor);
        listRequests.setAdapter(myRequestAdaptor);
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle bundle) {
        switch (id)
        {
            case LOADER_ACTIVITIES:
                ...
                final Uri uri = CouponContentProvider.CONTENT_URI_ALL_ACTIVITIES;
                return new CursorLoader(getActivity(), uri, null, null, null, null);


            case LOADER_REQUESTS:
                final Uri uri2 = CouponContentProvider.CONTENT_URI_ALL_REQUESTS;
                return new CursorLoader(getActivity(), uri2, null, null, null, null);
